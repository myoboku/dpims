...
public class Initialize extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Server Initialization wizard");
        setResizable(false);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Server Initialization Wizard");

        jLabel2.setText("Please select the sql file to upload.");
        ...
        jLabel3.setText("* The sql file should be a backup of old database or the file provided with");

        jLabel4.setText("    software. msgin and msg out tables will be truncated at the time of ");

        jLabel5.setText("server initialization but msglog must be truncated mannually");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String executeBackup="C:\\wamp\\bin\\mysql\\mysql5.6.17\\bin\\mysqldump -u root coa -r c:/coa/"+jTextField1.getText()+".sql";
